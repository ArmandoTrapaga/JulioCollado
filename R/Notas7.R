...
# Intercep es beta 0, heiht beta1 y girth es beta 2


##Nos regresa los coeficientes estimados, error estandar, t-valor(estimado/error)
## ----lm_example-----------------------------------------------
...
##Explore model matrix nos permite visualizar la relacion entre los coeficientes de la regresion lineal
##Para tener una mas presisa de los coeficientes y saber cuales son de interes. Sigue una logica de resta
...
## ----solve_issue----------------------------------------------
## Borramos dev_stage que no tienen todos las columnas
